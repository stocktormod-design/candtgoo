...
const BOT_QUESTIONS = [
  ...
  "Wheres the craziest place youd want to hook up?",
  "Whats a fantasy youve never told anyone?",
  "Whats the first thing you notice about someone?",
  "Would you rather give or receive?",
  "Whats your favorite thing to be complimented on?",
  "Dominant or submissive — which are you tonight?",
  "Whats something that instantly gets you in the mood?",
  "Lights on or lights off?",
  "Whats the most daring thing youve ever done?",
  "Whats your guilty pleasure?",
  "Morning sex or late night sex?",
  "Whats one thing youve always wanted to try?",
  "Whats your idea of the perfect date?",
  "Whats the fastest way to your heart?",
  "Slow and teasing, or fast and rough?",
  "Whats a secret you can only tell me?",
  "Whats the hottest outfit someone could wear for you?",
  "Would you rather be teased for an hour or get straight to it?",
  "Whats the last dream you had about someone?",
  "Whats your favorite body part on yourself?",
  "Whats something you find irresistible?",
  "Truth or dare — which do you pick?",
  "Whats the boldest text youve ever sent?",
  "If we were alone right now, what would you do first?"
];
